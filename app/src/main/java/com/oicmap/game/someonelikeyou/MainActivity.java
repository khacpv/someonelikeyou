...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        new Thread(new Runnable() {
            public void run() {
                HttpRequests httpRequests = new HttpRequests("038d3322ea5b6930755b3d453d2afa1a", "TaTOMJAkx8_KfcGMcVQ2DNtd0nh5zDbk");
                ...
                try {
                    ...
                    //detection/detect
                    result = httpRequests.detectionDetect(new PostParameters().setUrl("http://fullhdpictures.com/wp-content/uploads/2016/01/Most-Beautiful-Face-Girl-Wallpaper.jpg"));
